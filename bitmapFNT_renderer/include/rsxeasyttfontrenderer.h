...
public:
	...
	virtual void printPass(EasyTTFont::Position* pPositions, EasyTTFont::TexCoord* pTexCoords, EasyTTFont::Color* pColors, s32 numVerts, u32 *textmem_off, u32 tex_w, u32 tex_h);
...
private:
	...
	static u8* texture_mem;		//ttf_textures
